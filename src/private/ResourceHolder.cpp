...
void ResourceHolder::Init()
{
	...
	loadTexture(Textures::MainWall, path, mainWall);
	sf::IntRect Wall_1[1] = { { 256, 64, 8, 8 } };
	loadTexture(Textures::Wall_1, path, Wall_1);
	sf::IntRect Wall_2[1] = { { 256, 72, 8, 8 } };
	loadTexture(Textures::Wall_2, path, Wall_2);
	sf::IntRect GreenWall[1] = { { 264, 72, 8, 8 } };
	loadTexture(Textures::GreenWall, path, GreenWall);
	sf::IntRect WaterWall[1] = { { 256, 80, 8, 8 } };
	loadTexture(Textures::WaterWall, path, WaterWall);
	...
	loadTexture(Textures::BonusStar, path, BonusStar);
	sf::IntRect BonusLife[1] = { { 336, 112, 16, 15 } };
	loadTexture(Textures::BonusLife, path, BonusLife);
	sf::IntRect BonusMissle[1] = { { 352, 112, 16, 15 } };
	loadTexture(Textures::BonusMissle, path, BonusMissle);
	...
	loadTexture(Textures::RightPanel, path, RightPanel);

	// Tank icon
	sf::IntRect TankIcon[1] = { { 320, 192, 8, 8 } };
	loadTexture(Textures::TankIcon, path, TankIcon);

	// Digits
	sf::IntRect Digit_0[1] = { { 328, 183, 8, 9 } };
	loadTexture(Textures::Digit_0, path, Digit_0);
	sf::IntRect Digit_1[1] = { { 337, 183, 7, 9 } };
	loadTexture(Textures::Digit_1, path, Digit_1);
	sf::IntRect Digit_2[1] = { { 344, 183, 8, 9 } };
	loadTexture(Textures::Digit_2, path, Digit_2);
	sf::IntRect Digit_3[1] = { { 352, 183, 8, 9 } };
	loadTexture(Textures::Digit_3, path, Digit_3);
	sf::IntRect Digit_4[1] = { { 360, 183, 8, 9 } };
	loadTexture(Textures::Digit_4, path, Digit_4);
	sf::IntRect Digit_5[1] = { { 328, 191, 8, 9 } };
	loadTexture(Textures::Digit_5, path, Digit_5);
	sf::IntRect Digit_6[1] = { { 336, 191, 8, 9 } };
	loadTexture(Textures::Digit_6, path, Digit_6);
	sf::IntRect Digit_7[1] = { { 344, 191, 8, 9 } };
	loadTexture(Textures::Digit_7, path, Digit_7);
	sf::IntRect Digit_8[1] = { { 352, 191, 8, 9 } };
	loadTexture(Textures::Digit_8, path, Digit_8);
	sf::IntRect Digit_9[1] = { { 360, 191, 8, 9 } };
	loadTexture(Textures::Digit_9, path, Digit_9);
